...
private:
	...
	//Description: Helper methods for destructor
	void destructTraverse(BST<ElementType>& aBST);
	void destructTraverseR(BSTNode<ElementType>* current);

	//Description: Helper methods for copy constructor
	void copyTraverse(const BST<ElementType>& original, BST<ElementType>& copy);
	void copyTraverseR(BSTNode<ElementType>* current, BST<ElementType>& copy);
